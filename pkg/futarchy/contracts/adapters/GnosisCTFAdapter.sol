...
import "../../../interfaces/contracts/futarchy/IConditionalTokens.sol";
import "../../../interfaces/contracts/futarchy/IWrapped1155Factory.sol";
...
contract GnosisCTFAdapter {
    ...
    function splitCollateralTokens(
        ...
        // TODO: replace ConditionalTokens contract 
        // with one where splitPosition _returns_ the positionIds
